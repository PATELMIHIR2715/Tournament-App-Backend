...
$token = "826247-f9d3a5-14a02c-b74dc1-610bda";	// Your Api Token https://upiapi.in/APIKeys
$curl = curl_init();
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS =>'{
    ...
    "callbackUrl": "https://aliveztechnosoft.com/CodeCanyon/TournamentApp/Payment-Gateways/UpiApi/response.php"
}',
...
echo '<div class="alert alert-danger">oo'.$result['message'].'</div>';
}
?>
<h2>Test Demo</h2>
